<template>
  <main class="container center unit">
    ...
    <div class="unit__head">
      ...
      <h2 class="unit__head-name">Overseer</h2>
...
const stats = reactive({
  name: "Overseer",
  stats: [7, 5, 5, 4, 4, 3, 5, 4, 9, 9, 8, 8, 2, "5+"],
  sergeant: "",
  Sstats: "",
  ...
  Dwargear: {
    ...
    melee_weapons: ["power lash", "krak grenades"],
  ...
  options: [
    {
      scentence: "This Model may have its Power Lash exchanged for:",
      variants: [
        {
          what: "power maul",
          cost: [0, "pts"],
