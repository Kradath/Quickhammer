<template>
  <main class="container center unit">
    ...
    <div class="unit__head">
      ...
      <h2 class="unit__head-name">Vheren Ashurahaddon</h2>
...
const stats = reactive({
  name: "Vheren",
  stats: [7, 7, 5, 4, 4, 4, 5, 5, 10, 9, 9, 9, 2, "4+"],
  sergeant: "",
  Sstats: "",
  ...
  twoProfiles: false,
  Dwargear: {
    ranged_weapons: ["banestrike fussilade"],
    melee_weapons: ["the axe serpentis"],
    wargear: [
      "frag grenades",
      "krak grenades",
      "vexilla"
  ...
  traits: ["traitor", "sons of horus", "master of the legion"],
  options: false,
});
</script>